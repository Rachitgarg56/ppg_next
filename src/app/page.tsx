  ...
  return (
    <>
      <div className='bg-black pb-32'>
        ...
        {/* Quote */}
        <div className="text-center mx-auto w-full md:w-2/3 leading-relaxed">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between mt-24">
            <Link href="#" className="border border-gray-100 px-16 py-6 text-2xl md:text-3xl text-[#178DA1] italic tracking-wider font-cambria font-semibold w-full">capabilities</Link>
            <Link href="#" className="border border-gray-100 px-16 py-6 text-2xl md:text-3xl text-[#178DA1] italic tracking-wider font-cambria font-semibold mt-8 md:mt-0 md:ml-16 w-full">work with us</Link>
          </div>
        </div>
      </div>
