...
const PageContent = () => {
  return (
    <div className='bg-gradient-to-r from-[#125F6C] via-[#1C7A8A] via-30% to-[#178DA1] text-white pb-8'>
        ...
        <div className="mt-8 text-2xl sm:text-3xl tracking-wide leading-relaxed px-8 mx-auto text-center font-thin sm:w-2/3 pb-4 md:pb-16">
        ...
        <div className='flex flex-col items-center gap-8 px-4 py-16'>
            ...
            <button className='text-2xl text-[#178DA1] sm:text-3xl max-sm:px-8 px-12 sm:px-16 py-6 bg-black leading-relaxed text-center font-cambria font-bold italic cursor-pointer mt-4'>check open positions</button>
