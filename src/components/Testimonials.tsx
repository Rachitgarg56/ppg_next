...
const Testimonials = () => {
  ...
  return (
    <div className="bg-[#178DA1] text-white text-center py-12 sm:py-24 md:py-48 overflow-hidden">
        ...
        <div className="w-full overflow-hidden">
          ...
          >
            {testimonials.map((t, i) => (
              <div key={i} className="w-full flex-shrink-0 px-4 sm:px-8 md:px-40 leading-relaxed">
                <div className="text-xl md:text-2xl font-thin">{t.text}</div>
