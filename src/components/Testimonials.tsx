...
const testimonials = [
  {name: "Brooke Bergeron", company: "Boston Beer Company", designation: "District Manager", text: "I’ve had the pleasure of working with Prestige Promotions for several years for events from small to large, and I can’t recommend them highly enough. Their team has proven to be <em>incredibly reliable and trustworthy</em>. They consistently show up on time, and always have a deep knowledge of our products. Prestige has become a valuable partner to Boston Beer Co.", },
  {name: "Jeff Bee", company: "Constellation Brands", designation: "National Account Manager", text: "...I cannot speak highly enough of their exceptional service and dedication. They have <em>consistently gone above and beyond</em> in conducting hand-selling events at Walmart locations for my business. Their team is <em>professional, enthusiastic, and highly skilled at engaging customers and driving sales</em>… Prestige Promotions has been a key factor in our success… If you are looking for a <em>reliable and effective promotional partner</em>, I highly recommend Prestige Promotions…", },
