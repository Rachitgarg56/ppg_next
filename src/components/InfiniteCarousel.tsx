    ...
    >
      ...
      >
        {finalData.map((data, idx) => (
          ...
          >
            <div className="w-[70%] lg:w-[40%] aspect-square self-center bg-white text-black flex items-center justify-center text-lg font-cambria font-bold italic rounded-full">
              {data.title}
            </div>
